...
@section('content')
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <h1 class="display-2 text-uppercase text-white mb-md-4">無料引き取りゴミ回収します。</h1>
                            <a href="" class="btn btn-primary py-md-3 px-md-5 mt-2">無料引き取りゴミ</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid py-6 px-5">
        <div class="row g-5">
            <div class="col-lg-7">
                <h1 class="display-5 text-uppercase mb-4">私たちは <span class="text-primary">お客様の</span> 希望通り</h1>
                <h4 class="text-uppercase mb-3 text-body">しっかりしますので任せてください。</h4>
    ...
    <div class="container-fluid bg-light py-6 px-5">
        <div class="text-center mx-auto mb-5" style="max-width: 600px;">
            <h1 class="display-5 text-uppercase mb-4"> <span class="text-primary"></span> サービス一覧</h1>
        </div>
        <div class="row g-5">
